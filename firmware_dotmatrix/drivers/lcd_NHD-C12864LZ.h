...
// Tetris Add 
#define U8_LCD_IMAGE_ROW_PIXEL_BLOCK2    (u8)16
#define U8_LCD_IMAGE_ROW_PIXEL_BLOCK4    (u8)24
#define U8_LCD_IMAGE_ROW_PIXEL_BLOCK2PX  (u8)((U8_LCD_IMAGE_ROW_PIXEL_BLOCK2 * U8_LCD_PIXEL_BITS / 8) + 1)
#define U8_LCD_IMAGE_ROW_PIXEL_BLOCK4PX  (u8)((U8_LCD_IMAGE_ROW_PIXEL_BLOCK4 * U8_LCD_PIXEL_BITS / 8) + 1)
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK1 (u8)6
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK2 (u8)11
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK3 (u8)16
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK1PX (u8)((U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK1 * U8_LCD_PIXEL_BITS / 8) + 1)
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK2PX (u8)((U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK2 * U8_LCD_PIXEL_BITS / 8) + 1)
#define U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK3PX (u8)((U8_LCD_IMAGE_COLUMN_PIXEL_BLOCK3 * U8_LCD_PIXEL_BITS / 8) + 1)
