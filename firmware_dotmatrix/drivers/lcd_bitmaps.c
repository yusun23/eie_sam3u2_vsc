...
// Piano Keys
const u8 DefaultFrontKeys[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    ...
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0x38, 0x00},
...
const u8 CKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    ...
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0xFD, 0x03, 0xFC, 0x03, 0x38, 0x00},
    {0xFD, 0x61, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0xFD, 0x6F, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0xFD, 0x6F, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0xFD, 0x6F, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0xFD, 0x6F, 0x00, 0x60, 0x00, 0x38, 0x00},
    {0xFD, 0x6F, 0x00, 0x60, 0x00, 0x38, 0x00},
...
const u8 DKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    ...
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0xFC, 0xFB, 0xFD, 0x03, 0x38, 0x00},
    {0x01, 0x60, 0xF8, 0x61, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0xFF, 0x6F, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0xFF, 0x6F, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0xFF, 0x6F, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0xFF, 0x6F, 0x00, 0x38, 0x00},
    {0x01, 0x60, 0xFF, 0x6F, 0x00, 0x38, 0x00},
...
const u8 EKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    ...
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0xFC, 0x03, 0xFC, 0xFB, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xF8, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xFF, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xFF, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xFF, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xFF, 0x3B, 0x00},
    {0x01, 0x60, 0x00, 0x60, 0xFF, 0x3B, 0x00},
...
const u8 FKeyFront[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    ...
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0xFC, 0x03, 0xFC, 0x03, 0xB8, 0x03},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0xB8, 0x03},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0xB8, 0x03},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0xB8, 0x03},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0xB8, 0x03},
    {0x01, 0x60, 0x00, 0x60, 0x00, 0xB8, 0x03},
...
const u8 CSharpKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0x04, 0x02, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0x04, 0x02, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0x04, 0x02, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0x04, 0x02, 0xFC, 0x03, 0x38, 0x00},
    {0x01, 0x04, 0x02, 0xFC, 0x03, 0x38, 0x00},
...
const u8 DSharpKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x01, 0xFC, 0x03, 0x04, 0x02, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0x04, 0x02, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0x04, 0x02, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0x04, 0x02, 0x38, 0x00},
    {0x01, 0xFC, 0x03, 0x04, 0x02, 0x38, 0x00},
...
const u8 DefaultBackKeys[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    ...
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
    ...
    const u8 FKeyBack[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        ...
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0xF7, 0x0F, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
        {0x87, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
        {0xBF, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
        {0xBF, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
        {0xBF, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
        {0xBF, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
        {0xBF, 0x01, 0x80, 0x01, 0x80, 0x01, 0x02},
...
const u8 GKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    ...
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0xF0, 0xEF, 0xF7, 0x0F, 0xF0, 0x0F, 0x02},
    {0x80, 0xE1, 0x87, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0xFD, 0xBF, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0xFD, 0xBF, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0xFD, 0xBF, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0xFD, 0xBF, 0x01, 0x80, 0x01, 0x02},
    {0x80, 0xFD, 0xBF, 0x01, 0x80, 0x01, 0x02},
...
const u8 AKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    ...
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0xF0, 0x0F, 0xF0, 0xEF, 0xF7, 0x0F, 0x02},
    {0x80, 0x01, 0x80, 0xE1, 0x87, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0xFD, 0xBF, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0xFD, 0xBF, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0xFD, 0xBF, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0xFD, 0xBF, 0x01, 0x02},
    {0x80, 0x01, 0x80, 0xFD, 0xBF, 0x01, 0x02},
...
const u8 BKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    ...
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0xF0, 0xEF, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xE1, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xFD, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xFD, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xFD, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xFD, 0x02},
    {0x80, 0x01, 0x80, 0x01, 0x80, 0xFD, 0x02},
...
const u8 FSharpKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0x10, 0x08, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0x10, 0x08, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0x10, 0x08, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0x10, 0x08, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
    {0x10, 0x08, 0xF0, 0x0F, 0xF0, 0x0F, 0x02},
...
const u8 ASharpKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0x0F, 0xF0, 0x0F, 0x10, 0x08, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0x10, 0x08, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0x10, 0x08, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0x10, 0x08, 0x02},
    {0xF0, 0x0F, 0xF0, 0x0F, 0x10, 0x08, 0x02},
...
const u8 GSharpKey[U8_LCD_IMAGE_ROW_SIZE_50PX][U8_LCD_IMAGE_COL_BYTES_50PX] = {
    {0xF0, 0x0F, 0x10, 0x08, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0x10, 0x08, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0x10, 0x08, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0x10, 0x08, 0xF0, 0x0F, 0x02},
    {0xF0, 0x0F, 0x10, 0x08, 0xF0, 0x0F, 0x02},
